...
def get_data(loc):
    ...
    df.rename(columns={'tmax (deg c)': 'TmaxC','tmin (deg c)': 'TminC'}, inplace=True)
    
    # And provide temperature in F for US people
    df['TmaxF'] = df['TmaxC']*9/5 + 32
    df['TminF'] = df['TminC']*9/5 + 32
